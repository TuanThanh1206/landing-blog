        ...
        <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/[0.08] bg-[#020307]/80 backdrop-blur-xl transition-all duration-300">
            <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
                ...
                <nav className="hidden items-center gap-6 lg:gap-8 md:flex">
                    ...
                    >
                        ...
                        {isServicesDropdownOpen && (
                            <div className="absolute top-full left-0 mt-3 w-64 rounded-xl border border-white/10 bg-[#020307]/95 backdrop-blur-xl shadow-2xl py-2 animate-in fade-in slide-in-from-top-2 duration-200">
                                <div className="flex flex-col">
                                    {servicesItems.map((item) => (
                                        <Link
                                            key={item.name}
                                            href={item.href}
                                            className="block rounded-md px-4 py-2.5 text-sm text-slate-300 transition-colors hover:bg-white/5 hover:text-emerald-300"
                                        >
                                            {item.name}
                                        </Link>
                                    ))}
                ...
                <button
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-lg border border-white/10 text-white md:hidden hover:bg-white/5 transition-colors"
                >
                    ...
                    <nav className="flex flex-col gap-6">
                        ...
                        <div>
                            ...
                            {isMobileServicesOpen && (
                                <div className="mt-3 ml-2 flex flex-col gap-2 border-l border-white/10 pl-4">
                                    {servicesItems.map((item) => (
                                        <Link
                                            key={item.name}
                                            href={item.href}
                        ...
                        <Link
                            href="/contact"
                            onClick={() => setIsMobileMenuOpen(false)}
                            className="flex h-12 w-full items-center justify-center rounded-xl bg-gradient-to-r from-emerald-500 to-cyan-500 text-base font-bold text-white shadow-lg transition-all hover:shadow-[0_0_20px_rgba(52,211,153,0.6)]"
                        >
                            Request Audit
                        </Link>
                    </nav>
